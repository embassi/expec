...
export default function PoliciesClient({ initialCommunities, initialPolicy, defaultCommunityId }: Props) {
  ...
  const { data: policy } = useFetch<Policy>(
    ...
    { fallbackData: communityId === defaultCommunityId ? initialPolicy ?? undefined : undefined }
  );
